...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"chat","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var myHttp = function myHttp(options) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    uni.request({
      url: _commom.BASE_URL + options.url,
...
var myUploadFile = function myUploadFile(options) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.BASE_URL = exports.socketSeverUrl = void 0; // export const socketSeverUrl = 'http://localhost:3002'
// export const BASE_URL = 'http://localhost:3001'
var socketSeverUrl = 'http://192.168.43.207:3002';exports.socketSeverUrl = socketSeverUrl;
var BASE_URL = 'http://192.168.43.207:3001';exports.BASE_URL = BASE_URL;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.emojiArr = void 0;var emojiArr = [
['😀', '😁', '😂', '🤣', '😃', '😄', '😅'],
['😆', '😉', '😊', '😋', '😎', '😍', '😘'],
['😗', '😙', '😚', '😇', '🙂', '🤗', '🤔'],
['😐', '😑', '😶', '🙄', '😏', '😣', '😥'],
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.generateUUID = generateUUID;function generateUUID() {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = _default;function _default() {
  var tokenValue = uni.getStorageSync('token_id');
  if (!tokenValue) {
    uni.redirectTo({
      url: '/pages/login/login' });
...
function getChatTime(newTime, oldTime) {
  var time = '';
  // 获取当前数据的时间
