...
/* harmony import */ var _message_vue_vue_type_template_id_94069398_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./message.vue?vue&type=template&id=94069398&scoped=true& */ 151);
/* harmony import */ var _message_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./message.vue?vue&type=script&lang=js& */ 153);
...
/* harmony import */ var _message_vue_vue_type_style_index_0_id_94069398_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./message.vue?vue&type=style&index=0&id=94069398&lang=scss&scoped=true& */ 155);
...
var recordPlay = {};var _default =
{
  ...
  methods: {
      ...
      this.socket.on('message', function (message) {
        if (!message.groupid && (message.userid == _this2.friendid || message.userid == _this2.userid) || message.groupid == _this2.groupid) {
          ...
          if (newMessage.type == 1) {
            ...
            _this2.imageList.push(newMessage.content);
            ...
            recordPlay[name] = true;
            _this2.recordArr.push(name);
            console.log("this.recordArr.length", _this2.recordArr.length);
    ...
    playRecordHandler: function playRecordHandler(record) {
      ...
      var isPlay = recordPlay[record];
      //判断当前点击的和上一次是否一样，如果一样说明有一次是播放，一次是暂停，所以需要把this.recordPlay[record]改了
      if (lastRecord == record) {
        recordPlay[record] = !isPlay;
        isPlay = recordPlay[record];
        // console.log('播放/停止录音');
